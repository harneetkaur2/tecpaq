<?php
namespace Ess\M2ePro\Block\Adminhtml\Template\SellingFormat\Messages;

/**
 * Interceptor class for @see \Ess\M2ePro\Block\Adminhtml\Template\SellingFormat\Messages
 */
class Interceptor extends \Ess\M2ePro\Block\Adminhtml\Template\SellingFormat\Messages implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCurrencyConversionMessage');
        if (!$pluginInfo) {
            return parent::getCurrencyConversionMessage($marketplaceCurrency);
        } else {
            return $this->___callPlugins('getCurrencyConversionMessage', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getResultBlock');
        if (!$pluginInfo) {
            return parent::getResultBlock($templateNick, $componentMode);
        } else {
            return $this->___callPlugins('getResultBlock', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getMessagesHtml');
        if (!$pluginInfo) {
            return parent::getMessagesHtml($messages);
        } else {
            return $this->___callPlugins('getMessagesHtml', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAttributesAvailabilityMessage');
        if (!$pluginInfo) {
            return parent::getAttributesAvailabilityMessage();
        } else {
            return $this->___callPlugins('getAttributesAvailabilityMessage', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setTemplateNick');
        if (!$pluginInfo) {
            return parent::setTemplateNick($templateNick);
        } else {
            return $this->___callPlugins('setTemplateNick', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setComponentMode');
        if (!$pluginInfo) {
            return parent::setComponentMode($componentMode);
        } else {
            return $this->___callPlugins('setComponentMode', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getComponentMode');
        if (!$pluginInfo) {
            return parent::getComponentMode();
        } else {
            return $this->___callPlugins('getComponentMode', func_get_args(), $pluginInfo);
        }
    }
