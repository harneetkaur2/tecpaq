<?php
namespace Ess\M2ePro\Block\Adminhtml\Listing\Product\Rule;

/**
 * Interceptor class for @see \Ess\M2ePro\Block\Adminhtml\Listing\Product\Rule
 */
class Interceptor extends \Ess\M2ePro\Block\Adminhtml\Listing\Product\Rule implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setShowHideProductsOption');
        if (!$pluginInfo) {
            return parent::setShowHideProductsOption($isShow);
        } else {
            return $this->___callPlugins('setShowHideProductsOption', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isShowHideProductsOption');
        if (!$pluginInfo) {
            return parent::isShowHideProductsOption();
        } else {
            return $this->___callPlugins('isShowHideProductsOption', func_get_args(), $pluginInfo);
        }
    }
