<?php
namespace Ess\M2ePro\Block\Adminhtml\Listing\Product\ShowOthersListingsProductsFilter;

/**
 * Interceptor class for @see \Ess\M2ePro\Block\Adminhtml\Listing\Product\ShowOthersListingsProductsFilter
 */
class Interceptor extends \Ess\M2ePro\Block\Adminhtml\Listing\Product\ShowOthersListingsProductsFilter implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getParamName');
        if (!$pluginInfo) {
            return parent::getParamName();
        } else {
            return $this->___callPlugins('getParamName', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getFilterUrl');
        if (!$pluginInfo) {
            return parent::getFilterUrl();
        } else {
            return $this->___callPlugins('getFilterUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isChecked');
        if (!$pluginInfo) {
            return parent::isChecked();
        } else {
            return $this->___callPlugins('isChecked', func_get_args(), $pluginInfo);
        }
    }
