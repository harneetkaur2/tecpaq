<?php
namespace Ess\M2ePro\Block\Adminhtml\Listing\View\Header;

/**
 * Interceptor class for @see \Ess\M2ePro\Block\Adminhtml\Listing\View\Header
 */
class Interceptor extends \Ess\M2ePro\Block\Adminhtml\Listing\View\Header implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isListingViewMode');
        if (!$pluginInfo) {
            return parent::isListingViewMode();
        } else {
            return $this->___callPlugins('isListingViewMode', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setListingViewMode');
        if (!$pluginInfo) {
            return parent::setListingViewMode($mode);
        } else {
            return $this->___callPlugins('setListingViewMode', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getProfileTitle');
        if (!$pluginInfo) {
            return parent::getProfileTitle();
        } else {
            return $this->___callPlugins('getProfileTitle', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAccountTitle');
        if (!$pluginInfo) {
            return parent::getAccountTitle();
        } else {
            return $this->___callPlugins('getAccountTitle', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getMarketplaceTitle');
        if (!$pluginInfo) {
            return parent::getMarketplaceTitle();
        } else {
            return $this->___callPlugins('getMarketplaceTitle', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getStoreViewBreadcrumb');
        if (!$pluginInfo) {
            return parent::getStoreViewBreadcrumb($cutLongValues);
        } else {
            return $this->___callPlugins('getStoreViewBreadcrumb', func_get_args(), $pluginInfo);
        }
    }
