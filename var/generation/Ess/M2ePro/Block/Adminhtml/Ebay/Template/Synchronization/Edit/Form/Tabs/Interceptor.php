...
class Interceptor extends \Ess\M2ePro\Block\Adminhtml\Ebay\Template\Synchronization\Edit\Form\Tabs implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAccordion');
        if (!$pluginInfo) {
            return parent::getAccordion($parentTab);
        } else {
            return $this->___callPlugins('getAccordion', func_get_args(), $pluginInfo);
        }
    }
