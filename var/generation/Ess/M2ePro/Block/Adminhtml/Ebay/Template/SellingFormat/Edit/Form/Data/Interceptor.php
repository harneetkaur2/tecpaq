<?php
namespace Ess\M2ePro\Block\Adminhtml\Ebay\Template\SellingFormat\Edit\Form\Data;

/**
 * Interceptor class for @see \Ess\M2ePro\Block\Adminhtml\Ebay\Template\SellingFormat\Edit\Form\Data
 */
class Interceptor extends \Ess\M2ePro\Block\Adminhtml\Ebay\Template\SellingFormat\Edit\Form\Data implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\App\ResourceConnection $resourceConnection, \Magento\Framework\Locale\Currency $currency, \Ess\M2ePro\Model\Config\Manager\Cache $cacheConfig, \Ess\M2ePro\Model\ActiveRecord\Component\Parent\Ebay\Factory $ebayFactory, \Ess\M2ePro\Block\Adminhtml\Magento\Context\Template $context, \Magento\Framework\Registry $registry, \Magento\Framework\Data\FormFactory $formFactory, array $data = array())
    {
        $this->___init();
        parent::__construct($resourceConnection, $currency, $cacheConfig, $ebayFactory, $context, $registry, $formFactory, $data);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isStpAvailable');
        if (!$pluginInfo) {
            return parent::isStpAvailable();
        } else {
            return $this->___callPlugins('isStpAvailable', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isStpAdvancedAvailable');
        if (!$pluginInfo) {
            return parent::isStpAdvancedAvailable();
        } else {
            return $this->___callPlugins('isStpAdvancedAvailable', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isMapAvailable');
        if (!$pluginInfo) {
            return parent::isMapAvailable();
        } else {
            return $this->___callPlugins('isMapAvailable', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getTaxCategoriesInfo');
        if (!$pluginInfo) {
            return parent::getTaxCategoriesInfo();
        } else {
            return $this->___callPlugins('getTaxCategoriesInfo', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCharityDictionary');
        if (!$pluginInfo) {
            return parent::getCharityDictionary();
        } else {
            return $this->___callPlugins('getCharityDictionary', func_get_args(), $pluginInfo);
        }
    }
