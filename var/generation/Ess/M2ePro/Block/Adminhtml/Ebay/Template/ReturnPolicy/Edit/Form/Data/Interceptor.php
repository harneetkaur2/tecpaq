...
class Interceptor extends \Ess\M2ePro\Block\Adminhtml\Ebay\Template\ReturnPolicy\Edit\Form\Data implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'canShowHolidayReturnOption');
        if (!$pluginInfo) {
            return parent::canShowHolidayReturnOption();
        } else {
            return $this->___callPlugins('canShowHolidayReturnOption', func_get_args(), $pluginInfo);
        }
    }
