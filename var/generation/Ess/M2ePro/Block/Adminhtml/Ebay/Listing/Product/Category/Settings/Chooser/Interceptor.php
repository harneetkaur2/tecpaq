...
class Interceptor extends \Ess\M2ePro\Block\Adminhtml\Ebay\Listing\Product\Category\Settings\Chooser implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setAccountId');
        if (!$pluginInfo) {
            return parent::setAccountId($accountId);
        } else {
            return $this->___callPlugins('setAccountId', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setConvertedInternalData');
        if (!$pluginInfo) {
            return parent::setConvertedInternalData($data);
        } else {
            return $this->___callPlugins('setConvertedInternalData', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setSingleCategoryData');
        if (!$pluginInfo) {
            return parent::setSingleCategoryData($data);
        } else {
            return $this->___callPlugins('setSingleCategoryData', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getDivId');
        if (!$pluginInfo) {
            return parent::getDivId();
        } else {
            return $this->___callPlugins('getDivId', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setDivId');
        if (!$pluginInfo) {
            return parent::setDivId($divId);
        } else {
            return $this->___callPlugins('setDivId', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSelectCallback');
        if (!$pluginInfo) {
            return parent::getSelectCallback();
        } else {
            return $this->___callPlugins('getSelectCallback', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setSelectCallback');
        if (!$pluginInfo) {
            return parent::setSelectCallback($callback);
        } else {
            return $this->___callPlugins('setSelectCallback', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getUnselectCallback');
        if (!$pluginInfo) {
            return parent::getUnselectCallback();
        } else {
            return $this->___callPlugins('getUnselectCallback', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setUnselectCallback');
        if (!$pluginInfo) {
            return parent::setUnselectCallback($callback);
        } else {
            return $this->___callPlugins('setUnselectCallback', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isSingleCategoryMode');
        if (!$pluginInfo) {
            return parent::isSingleCategoryMode();
        } else {
            return $this->___callPlugins('isSingleCategoryMode', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setSingleCategoryMode');
        if (!$pluginInfo) {
            return parent::setSingleCategoryMode($mode);
        } else {
            return $this->___callPlugins('setSingleCategoryMode', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSingleCategoryType');
        if (!$pluginInfo) {
            return parent::getSingleCategoryType();
        } else {
            return $this->___callPlugins('getSingleCategoryType', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setSingleCategoryType');
        if (!$pluginInfo) {
            return parent::setSingleCategoryType($type);
        } else {
            return $this->___callPlugins('setSingleCategoryType', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isShowEditLinks');
        if (!$pluginInfo) {
            return parent::isShowEditLinks();
        } else {
            return $this->___callPlugins('isShowEditLinks', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setShowEditLinks');
        if (!$pluginInfo) {
            return parent::setShowEditLinks($isShow);
        } else {
            return $this->___callPlugins('setShowEditLinks', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isShowStoreCatalog');
        if (!$pluginInfo) {
            return parent::isShowStoreCatalog();
        } else {
            return $this->___callPlugins('isShowStoreCatalog', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getHelpBlockHtml');
        if (!$pluginInfo) {
            return parent::getHelpBlockHtml();
        } else {
            return $this->___callPlugins('getHelpBlockHtml', func_get_args(), $pluginInfo);
        }
    }
