<?php
namespace Ess\M2ePro\Block\Adminhtml\Ebay\Listing\AutoAction\Mode\Breadcrumb;

/**
 * Interceptor class for @see \Ess\M2ePro\Block\Adminhtml\Ebay\Listing\AutoAction\Mode\Breadcrumb
 */
class Interceptor extends \Ess\M2ePro\Block\Adminhtml\Ebay\Listing\AutoAction\Mode\Breadcrumb implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setContainerData');
        if (!$pluginInfo) {
            return parent::setContainerData($data);
        } else {
            return $this->___callPlugins('setContainerData', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getContainerData');
        if (!$pluginInfo) {
            return parent::getContainerData($key);
        } else {
            return $this->___callPlugins('getContainerData', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getSteps()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getSteps', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setSteps');
        if (!$pluginInfo) {
            return parent::setSteps($steps);
        } else {
            return $this->___callPlugins('setSteps', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSelectedStep');
        if (!$pluginInfo) {
            return parent::getSelectedStep();
        } else {
            return $this->___callPlugins('getSelectedStep', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setSelectedStep');
        if (!$pluginInfo) {
            return parent::setSelectedStep($stepId);
        } else {
            return $this->___callPlugins('setSelectedStep', func_get_args(), $pluginInfo);
        }
    }
