<?php
namespace Ess\M2ePro\Block\Adminhtml\Ebay\Listing\Product\Add\Product\Grid;

/**
 * Interceptor class for @see \Ess\M2ePro\Block\Adminhtml\Ebay\Listing\Product\Add\Product\Grid
 */
class Interceptor extends \Ess\M2ePro\Block\Adminhtml\Ebay\Listing\Product\Add\Product\Grid implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'callbackColumnWebsites');
        if (!$pluginInfo) {
            return parent::callbackColumnWebsites($value, $row, $column, $isExport);
        } else {
            return $this->___callPlugins('callbackColumnWebsites', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'callbackColumnProductId');
        if (!$pluginInfo) {
            return parent::callbackColumnProductId($value, $row, $column, $isExport);
        } else {
            return $this->___callPlugins('callbackColumnProductId', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'callbackColumnProductTitle');
        if (!$pluginInfo) {
            return parent::callbackColumnProductTitle($value, $row, $column, $isExport);
        } else {
            return $this->___callPlugins('callbackColumnProductTitle', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'callbackColumnIsInStock');
        if (!$pluginInfo) {
            return parent::callbackColumnIsInStock($value, $row, $column, $isExport);
        } else {
            return $this->___callPlugins('callbackColumnIsInStock', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'callbackColumnPrice');
        if (!$pluginInfo) {
            return parent::callbackColumnPrice($value, $row, $column, $isExport);
        } else {
            return $this->___callPlugins('callbackColumnPrice', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'callbackColumnQty');
        if (!$pluginInfo) {
            return parent::callbackColumnQty($value, $row, $column, $isExport);
        } else {
            return $this->___callPlugins('callbackColumnQty', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'callbackColumnStatus');
        if (!$pluginInfo) {
            return parent::callbackColumnStatus($value, $row, $column, $isExport);
        } else {
            return $this->___callPlugins('callbackColumnStatus', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAdvancedFilterButtonHtml');
        if (!$pluginInfo) {
            return parent::getAdvancedFilterButtonHtml();
        } else {
            return $this->___callPlugins('getAdvancedFilterButtonHtml', func_get_args(), $pluginInfo);
        }
    }
