...
class Interceptor extends \Ess\M2ePro\Block\Adminhtml\Ebay\Listing\Edit implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAllowedTabs');
        if (!$pluginInfo) {
            return parent::getAllowedTabs();
        } else {
            return $this->___callPlugins('getAllowedTabs', func_get_args(), $pluginInfo);
        }
    }
