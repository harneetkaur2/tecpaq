...
/**
 * Interceptor class for @see \Ess\M2ePro\Block\Adminhtml\Ebay\Listing\Template\Switcher
 */
class Interceptor extends \Ess\M2ePro\Block\Adminhtml\Ebay\Listing\Template\Switcher implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getHeaderText()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getHeaderText', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getHeaderWidth');
        if (!$pluginInfo) {
            return parent::getHeaderWidth();
        } else {
            return $this->___callPlugins('getHeaderWidth', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getTemplateNick');
        if (!$pluginInfo) {
            return parent::getTemplateNick();
        } else {
            return $this->___callPlugins('getTemplateNick', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getTemplateMode');
        if (!$pluginInfo) {
            return parent::getTemplateMode();
        } else {
            return $this->___callPlugins('getTemplateMode', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getTemplateObject');
        if (!$pluginInfo) {
            return parent::getTemplateObject();
        } else {
            return $this->___callPlugins('getTemplateObject', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isTemplateModeParentForced');
        if (!$pluginInfo) {
            return parent::isTemplateModeParentForced();
        } else {
            return $this->___callPlugins('isTemplateModeParentForced', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isTemplateModeParent');
        if (!$pluginInfo) {
            return parent::isTemplateModeParent();
        } else {
            return $this->___callPlugins('isTemplateModeParent', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isTemplateModeCustom');
        if (!$pluginInfo) {
            return parent::isTemplateModeCustom();
        } else {
            return $this->___callPlugins('isTemplateModeCustom', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isTemplateModeTemplate');
        if (!$pluginInfo) {
            return parent::isTemplateModeTemplate();
        } else {
            return $this->___callPlugins('isTemplateModeTemplate', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getFormDataBlock');
        if (!$pluginInfo) {
            return parent::getFormDataBlock();
        } else {
            return $this->___callPlugins('getFormDataBlock', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getFormDataBlockHtml');
        if (!$pluginInfo) {
            return parent::getFormDataBlockHtml($templateDataForce);
        } else {
            return $this->___callPlugins('getFormDataBlockHtml', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'canDisplaySwitcher');
        if (!$pluginInfo) {
            return parent::canDisplaySwitcher();
        } else {
            return $this->___callPlugins('canDisplaySwitcher', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'canDisplayUseDefaultOption');
        if (!$pluginInfo) {
            return parent::canDisplayUseDefaultOption();
        } else {
            return $this->___callPlugins('canDisplayUseDefaultOption', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getTemplates');
        if (!$pluginInfo) {
            return parent::getTemplates();
        } else {
            return $this->___callPlugins('getTemplates', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSwitcherJsObjectName');
        if (!$pluginInfo) {
            return parent::getSwitcherJsObjectName();
        } else {
            return $this->___callPlugins('getSwitcherJsObjectName', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSwitcherId');
        if (!$pluginInfo) {
            return parent::getSwitcherId();
        } else {
            return $this->___callPlugins('getSwitcherId', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSwitcherName');
        if (!$pluginInfo) {
            return parent::getSwitcherName();
        } else {
            return $this->___callPlugins('getSwitcherName', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getButtonsHtml()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getButtonsHtml', func_get_args(), $pluginInfo);
        }
    }
