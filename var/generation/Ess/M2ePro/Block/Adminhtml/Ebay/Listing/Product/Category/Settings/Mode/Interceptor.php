...
/**
 * Interceptor class for @see \Ess\M2ePro\Block\Adminhtml\Ebay\Listing\Product\Category\Settings\Mode
 */
class Interceptor extends \Ess\M2ePro\Block\Adminhtml\Ebay\Listing\Product\Category\Settings\Mode implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getDeleteUrl');
        if (!$pluginInfo) {
            return parent::getDeleteUrl();
        } else {
            return $this->___callPlugins('getDeleteUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getFormActionUrl()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getFormActionUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getFormInitScripts');
        if (!$pluginInfo) {
            return parent::getFormInitScripts();
        } else {
            return $this->___callPlugins('getFormInitScripts', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getFormScripts');
        if (!$pluginInfo) {
            return parent::getFormScripts();
        } else {
            return $this->___callPlugins('getFormScripts', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setDataObject');
        if (!$pluginInfo) {
            return parent::setDataObject($object);
        } else {
            return $this->___callPlugins('setDataObject', func_get_args(), $pluginInfo);
        }
    }
