<?php
namespace Ess\M2ePro\Block\Adminhtml\Ebay\Listing\Product\Category\Settings\Chooser\Edit;

/**
 * Interceptor class for @see \Ess\M2ePro\Block\Adminhtml\Ebay\Listing\Product\Category\Settings\Chooser\Edit
 */
class Interceptor extends \Ess\M2ePro\Block\Adminhtml\Ebay\Listing\Product\Category\Settings\Chooser\Edit implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCategoryType');
        if (!$pluginInfo) {
            return parent::getCategoryType();
        } else {
            return $this->___callPlugins('getCategoryType', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setCategoryType');
        if (!$pluginInfo) {
            return parent::setCategoryType($categoryType);
        } else {
            return $this->___callPlugins('setCategoryType', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCategoryTitle');
        if (!$pluginInfo) {
            return parent::getCategoryTitle();
        } else {
            return $this->___callPlugins('getCategoryTitle', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSelectedCategory');
        if (!$pluginInfo) {
            return parent::getSelectedCategory();
        } else {
            return $this->___callPlugins('getSelectedCategory', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setSelectedCategory');
        if (!$pluginInfo) {
            return parent::setSelectedCategory($selectedCategory);
        } else {
            return $this->___callPlugins('setSelectedCategory', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function removeButton($buttonId)
    {
        ...
        if (!$pluginInfo) {
            return parent::removeButton($buttonId);
        } else {
            return $this->___callPlugins('removeButton', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function updateButton($buttonId, $key, $data)
    {
        ...
        if (!$pluginInfo) {
            return parent::updateButton($buttonId, $key, $data);
        } else {
            return $this->___callPlugins('updateButton', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getButtonsHtml($region = null)
    {
        ...
        if (!$pluginInfo) {
            return parent::getButtonsHtml($region);
        } else {
    ...
    public function getHeaderCssClass()
    {
        ...
        if (!$pluginInfo) {
            return parent::getHeaderCssClass();
        } else {
            return $this->___callPlugins('getHeaderCssClass', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getHeaderHtml()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getHeaderHtml', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function hasFooterButtons()
    {
        ...
        if (!$pluginInfo) {
            return parent::hasFooterButtons();
        } else {
            return $this->___callPlugins('hasFooterButtons', func_get_args(), $pluginInfo);
        }
    }
