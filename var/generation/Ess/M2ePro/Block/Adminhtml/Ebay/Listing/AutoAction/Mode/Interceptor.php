...
/**
 * Interceptor class for @see \Ess\M2ePro\Block\Adminhtml\Ebay\Listing\AutoAction\Mode
 */
class Interceptor extends \Ess\M2ePro\Block\Adminhtml\Ebay\Listing\AutoAction\Mode implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\Data\FormFactory $formFactory, \Ess\M2ePro\Block\Adminhtml\Magento\Context\Template $context, array $data = array())
    {
        $this->___init();
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getHelpPageUrl');
        if (!$pluginInfo) {
            return parent::getHelpPageUrl();
        } else {
            return $this->___callPlugins('getHelpPageUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isAdminStore');
        if (!$pluginInfo) {
            return parent::isAdminStore();
        } else {
            return $this->___callPlugins('isAdminStore', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getWebsiteName');
        if (!$pluginInfo) {
            return parent::getWebsiteName();
        } else {
            return $this->___callPlugins('getWebsiteName', func_get_args(), $pluginInfo);
        }
    }
