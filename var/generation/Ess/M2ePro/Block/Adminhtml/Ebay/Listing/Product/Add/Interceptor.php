...
/**
 * Interceptor class for @see \Ess\M2ePro\Block\Adminhtml\Ebay\Listing\Product\Add
 */
class Interceptor extends \Ess\M2ePro\Block\Adminhtml\Ebay\Listing\Product\Add implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getGridHtml');
        if (!$pluginInfo) {
            return parent::getGridHtml();
        } else {
            return $this->___callPlugins('getGridHtml', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCreateUrl');
        if (!$pluginInfo) {
            return parent::getCreateUrl();
        } else {
            return $this->___callPlugins('getCreateUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAddButtonLabel');
        if (!$pluginInfo) {
            return parent::getAddButtonLabel();
        } else {
            return $this->___callPlugins('getAddButtonLabel', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getBackButtonLabel');
        if (!$pluginInfo) {
            return parent::getBackButtonLabel();
        } else {
            return $this->___callPlugins('getBackButtonLabel', func_get_args(), $pluginInfo);
        }
    }
