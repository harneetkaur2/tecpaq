<?php
namespace Ess\M2ePro\Block\Adminhtml\Ebay\Listing\AutoAction\Mode\GlobalMode;

/**
 * Interceptor class for @see \Ess\M2ePro\Block\Adminhtml\Ebay\Listing\AutoAction\Mode\GlobalMode
 */
class Interceptor extends \Ess\M2ePro\Block\Adminhtml\Ebay\Listing\AutoAction\Mode\GlobalMode implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'hasFormData');
        if (!$pluginInfo) {
            return parent::hasFormData();
        } else {
            return $this->___callPlugins('hasFormData', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getListing');
        if (!$pluginInfo) {
            return parent::getListing();
        } else {
            return $this->___callPlugins('getListing', func_get_args(), $pluginInfo);
        }
    }
