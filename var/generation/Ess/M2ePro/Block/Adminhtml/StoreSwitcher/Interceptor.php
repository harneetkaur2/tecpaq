<?php
namespace Ess\M2ePro\Block\Adminhtml\StoreSwitcher;

/**
 * Interceptor class for @see \Ess\M2ePro\Block\Adminhtml\StoreSwitcher
 */
class Interceptor extends \Ess\M2ePro\Block\Adminhtml\StoreSwitcher implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Store\Model\WebsiteFactory $websiteFactory, \Magento\Store\Model\GroupFactory $storeGroupFactory, \Magento\Store\Model\StoreFactory $storeFactory, \Ess\M2ePro\Block\Adminhtml\Magento\Context\Template $context, array $data = array())
    {
        $this->___init();
        parent::__construct($websiteFactory, $storeGroupFactory, $storeFactory, $context, $data);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isDisplayDefaultStoreModeUp');
        if (!$pluginInfo) {
            return parent::isDisplayDefaultStoreModeUp();
        } else {
            return $this->___callPlugins('isDisplayDefaultStoreModeUp', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isDisplayDefaultStoreModeDown');
        if (!$pluginInfo) {
            return parent::isDisplayDefaultStoreModeDown();
        } else {
            return $this->___callPlugins('isDisplayDefaultStoreModeDown', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isRequiredOption');
        if (!$pluginInfo) {
            return parent::isRequiredOption();
        } else {
            return $this->___callPlugins('isRequiredOption', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'hasEmptyOption');
        if (!$pluginInfo) {
            return parent::hasEmptyOption();
        } else {
            return $this->___callPlugins('hasEmptyOption', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getDefaultStoreName');
        if (!$pluginInfo) {
            return parent::getDefaultStoreName();
        } else {
            return $this->___callPlugins('getDefaultStoreName', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getStoreSelectId');
        if (!$pluginInfo) {
            return parent::getStoreSelectId();
        } else {
            return $this->___callPlugins('getStoreSelectId', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getStoreSelectName');
        if (!$pluginInfo) {
            return parent::getStoreSelectName();
        } else {
            return $this->___callPlugins('getStoreSelectName', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function hasDefaultOption()
    {
        ...
        if (!$pluginInfo) {
            return parent::hasDefaultOption();
        } else {
