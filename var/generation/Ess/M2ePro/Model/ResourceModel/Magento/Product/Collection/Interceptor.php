<?php
namespace Ess\M2ePro\Model\ResourceModel\Magento\Product\Collection;

/**
 * Interceptor class for @see \Ess\M2ePro\Model\ResourceModel\Magento\Product\Collection
 */
class Interceptor extends \Ess\M2ePro\Model\ResourceModel\Magento\Product\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Ess\M2ePro\Helper\Factory $helperFactory, \Ess\M2ePro\Model\Factory $modelFactory, \Ess\M2ePro\Model\ActiveRecord\Factory $activeRecordFactory, \Magento\CatalogInventory\Api\StockConfigurationInterface $stockConfiguration, \Magento\Framework\Data\Collection\EntityFactory $entityFactory, \Psr\Log\LoggerInterface $logger, \Magento\Framework\Data\Collection\Db\FetchStrategyInterface $fetchStrategy, \Magento\Framework\Event\ManagerInterface $eventManager, \Magento\Eav\Model\Config $eavConfig, \Magento\Framework\App\ResourceConnection $resource, \Magento\Eav\Model\EntityFactory $eavEntityFactory, \Magento\Catalog\Model\ResourceModel\Helper $resourceHelper, \Magento\Framework\Validator\UniversalFactory $universalFactory, \Magento\Store\Model\StoreManagerInterface $storeManager, \Magento\Framework\Module\Manager $moduleManager, \Magento\Catalog\Model\Indexer\Product\Flat\State $catalogProductFlatState, \Magento\Framework\App\Config\ScopeConfigInterface $scopeConfig, \Magento\Catalog\Model\Product\OptionFactory $productOptionFactory, \Magento\Catalog\Model\ResourceModel\Url $catalogUrl, \Magento\Framework\Stdlib\DateTime\TimezoneInterface $localeDate, \Magento\Customer\Model\Session $customerSession, \Magento\Framework\Stdlib\DateTime $dateTime, \Magento\Customer\Api\GroupManagementInterface $groupManagement, \Magento\Framework\DB\Adapter\AdapterInterface $connection = null)
    {
        $this->___init();
        parent::__construct($helperFactory, $modelFactory, $activeRecordFactory, $stockConfiguration, $entityFactory, $logger, $fetchStrategy, $eventManager, $eavConfig, $resource, $eavEntityFactory, $resourceHelper, $universalFactory, $storeManager, $moduleManager, $catalogProductFlatState, $scopeConfig, $productOptionFactory, $catalogUrl, $localeDate, $customerSession, $dateTime, $groupManagement, $connection);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setListingProductModeOn');
        if (!$pluginInfo) {
            return parent::setListingProductModeOn();
        } else {
            return $this->___callPlugins('setListingProductModeOn', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setListing');
        if (!$pluginInfo) {
            return parent::setListing($value);
        } else {
            return $this->___callPlugins('setListing', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setIsNeedToInjectPrices');
        if (!$pluginInfo) {
            return parent::setIsNeedToInjectPrices($value);
        } else {
            return $this->___callPlugins('setIsNeedToInjectPrices', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setIsNeedToUseIndexerParent');
        if (!$pluginInfo) {
            return parent::setIsNeedToUseIndexerParent($value);
        } else {
            return $this->___callPlugins('setIsNeedToUseIndexerParent', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isNeedUseIndexerParent');
        if (!$pluginInfo) {
            return parent::isNeedUseIndexerParent();
        } else {
            return $this->___callPlugins('isNeedUseIndexerParent', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'joinIndexerParent');
        if (!$pluginInfo) {
            return parent::joinIndexerParent();
        } else {
            return $this->___callPlugins('joinIndexerParent', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'joinStockItem');
        if (!$pluginInfo) {
            return parent::joinStockItem($columnsMap);
        } else {
            return $this->___callPlugins('joinStockItem', func_get_args(), $pluginInfo);
        }
    }
