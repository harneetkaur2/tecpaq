...
class Interceptor extends \Plazathemes\Featureproductslider\Block\Featureproductslider implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getFeaturedProduct');
        if (!$pluginInfo) {
            return parent::getFeaturedProduct();
        } else {
            return $this->___callPlugins('getFeaturedProduct', func_get_args(), $pluginInfo);
        }
    }
