...
class Interceptor extends \Plazathemes\Newproductslider\Block\Newproductslider implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getNewProduct');
        if (!$pluginInfo) {
            return parent::getNewProduct();
        } else {
            return $this->___callPlugins('getNewProduct', func_get_args(), $pluginInfo);
        }
    }
