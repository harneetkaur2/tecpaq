<?php
namespace Magento\Sales\Controller\Adminhtml\Invoice\Pdfinvoices;

/**
 * Interceptor class for @see \Magento\Sales\Controller\Adminhtml\Invoice\Pdfinvoices
 */
class Interceptor extends \Magento\Sales\Controller\Adminhtml\Invoice\Pdfinvoices implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'massAction');
        if (!$pluginInfo) {
            return parent::massAction($collection);
        } else {
            return $this->___callPlugins('massAction', func_get_args(), $pluginInfo);
        }
    }
