...
class Interceptor extends \Magento\Sales\Block\Adminhtml\Order\Create\Sidebar\Reorder implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getLastOrder');
        if (!$pluginInfo) {
            return parent::getLastOrder();
        } else {
            return $this->___callPlugins('getLastOrder', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'canDisplayItemQty');
        if (!$pluginInfo) {
            return parent::canDisplayItemQty();
        } else {
            return $this->___callPlugins('canDisplayItemQty', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'canRemoveItems');
        if (!$pluginInfo) {
            return parent::canRemoveItems();
        } else {
            return $this->___callPlugins('canRemoveItems', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'canDisplayPrice');
        if (!$pluginInfo) {
            return parent::canDisplayPrice();
        } else {
            return $this->___callPlugins('canDisplayPrice', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getIdentifierId');
        if (!$pluginInfo) {
            return parent::getIdentifierId($item);
        } else {
            return $this->___callPlugins('getIdentifierId', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSidebarStorageAction');
        if (!$pluginInfo) {
            return parent::getSidebarStorageAction();
        } else {
            return $this->___callPlugins('getSidebarStorageAction', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'canDisplay');
        if (!$pluginInfo) {
            return parent::canDisplay();
        } else {
            return $this->___callPlugins('canDisplay', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getCreateOrderModel()
    {
        ...
        if (!$pluginInfo) {
            return parent::getCreateOrderModel();
        } else {
            return $this->___callPlugins('getCreateOrderModel', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function convertPrice($value, $format = true)
    {
        ...
        if (!$pluginInfo) {
            return parent::convertPrice($value, $format);
        } else {
