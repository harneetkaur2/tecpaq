<?php
namespace Magento\Tax\Model\Config\Notification;

/**
 * Interceptor class for @see \Magento\Tax\Model\Config\Notification
 */
class Interceptor extends \Magento\Tax\Model\Config\Notification implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $this->___init();
        parent::__construct($context, $registry, $config, $cacheTypeList, $resourceConfig, $resource, $resourceCollection, $data);
    }
