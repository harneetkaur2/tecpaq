<?php
namespace Magenest\SagePay\Block\Catalog\Product\View;

/**
 * Interceptor class for @see \Magenest\SagePay\Block\Catalog\Product\View
 */
class Interceptor extends \Magenest\SagePay\Block\Catalog\Product\View implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Catalog\Block\Product\Context $context, \Magento\Framework\Stdlib\DateTime\DateTime $dateTime, \Magenest\SagePay\Model\PlanFactory $planFactory, array $data = array())
    {
        $this->___init();
        parent::__construct($context, $dateTime, $planFactory, $data);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getIsSubscriptionProduct');
        if (!$pluginInfo) {
            return parent::getIsSubscriptionProduct();
        } else {
            return $this->___callPlugins('getIsSubscriptionProduct', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSubscriptionOptions');
        if (!$pluginInfo) {
            return parent::getSubscriptionOptions();
        } else {
            return $this->___callPlugins('getSubscriptionOptions', func_get_args(), $pluginInfo);
        }
    }
